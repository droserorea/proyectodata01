...
/* themes/custom/drupalup_barrio/templates/views/views-view.html.twig */
class __TwigTemplate_edd3891f85e202c574c176826df7a7fe4cc7e654539b6d9a99aaba215180fd8e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["dom_id"] ?? null)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 39, $this->source))) : (""))];
  ...
  ";
        ...
        if (($context["rows"] ?? null)) {
            // line 65
            echo "    <div class=\"view-content row\" style=\"background-color: #292929\" >
      ";
            // line 66
...
";
    ...
    {
        return "themes/custom/drupalup_barrio/templates/views/views-view.html.twig";
    }
...
<div{{ attributes.addClass(classes) }}>
  ...
  {% if rows %}
    <div class=\"view-content row\" style=\"background-color: #292929\" >
      {{ rows }}
    </div>
  {% elseif empty %}
...
", "themes/custom/drupalup_barrio/templates/views/views-view.html.twig", "/app/web/themes/custom/drupalup_barrio/templates/views/views-view.html.twig");
    }
